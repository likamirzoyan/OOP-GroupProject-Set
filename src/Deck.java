public class Deck {
    ...
    public Deck() {
        ...
        int index = 0;
        // generating all possible combinations of 4 properties
        // looping through all colors and for each color we try every shape, filling and number
    ...
    /**
     * Resets the deck to start from the beginning and shuffle it
     * Assumes all cards were already created in constructor
     */
    public void reset() {
        currentCard = 0;
        shuffle();
